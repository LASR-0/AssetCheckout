    ...
    <div className="mt-2 rounded-lg border border-primary/40 bg-primary/5 p-3">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={!canCreate}
          onClick={() => void submit()}
          className="rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-on-primary disabled:opacity-40 hover:cursor-pointer disabled:hover:cursor-not-allowed"
        >
