  ...
  steps: [
    {
      ...
      body: "Sue administers ESS and unlocking is something she does directly; there is no portal request and no ticket to raise. The button below opens a Teams chat with her and writes the message for you; read it over and press send. If it opens empty, or you would rather write your own, search for Sue in Teams and start a chat yourself.",
      note: "If you are writing it yourself, say plainly that your ESS account is locked and that you would like it unlocked. “ESS won't let me in” covers several different problems and costs a round trip to sort out; naming the one you have gets it done in a single reply.",
      link: {
        label: "Message Sue about my locked ESS account",
        url: "https://teams.microsoft.com/l/chat/19:7f23fa78-eec2-49d7-bcf7-05b4f2c1bcbb_a09c7b9e-49d7-4022-88d6-b5fe87e50258@unq.gbl.spaces/conversations?context=%7B%22contextType%22%3A%22chat%22%7D&message=Hi%20Sue%2C%20would%20you%20be%20able%20to%20unlock%20my%20ESS%20account.%20Thank%20you.",
      },
    },
    {
