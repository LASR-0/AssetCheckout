  ...
  steps: [
    {
      ...
      body: "Unplug the HDMI cable at the computer and at the monitor, then push both ends firmly home. HDMI plugs have no latch and work loose over time, particularly on a computer that gets moved.",
    },
    {
