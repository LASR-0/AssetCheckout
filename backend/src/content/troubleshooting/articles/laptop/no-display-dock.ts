  ...
  steps: [
    {
      ...
      body: "Take the single cable running from the dock to the computer out entirely, count to ten, and push it firmly back in. This one step fixes more docking problems than you would think.",
