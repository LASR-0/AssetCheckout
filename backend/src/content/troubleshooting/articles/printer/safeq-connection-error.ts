...
const safeqConnectionError: Article = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Because the job lives in the queue rather than on any one device, any SAFEQ printer will give it to you. Tap in at a different one and release the job normally, if there is multiple printers that are effected by the cloud error, skip to alerting IT as there is most likely an underlying network issue.",
      note: "This is an immediate work around not a fix, this is a mitigation step if you need to print your work but do not have the time to troubleshoot the issue.",
      branch: {
    ...
    {
      title:
        "If you have to use that printer, and no other printers are effected.",
      body: "Try to power-cycle the printer by flicking the power switch under the clear latch on the right hand side of the printer about halfway down. count out to 15 seconds once switched off and then switch back on. ",
      note: "you will know this has worked if the cloud connection error message is no longer rendered on the screen of the printer when selecting app.",
    },
    {
