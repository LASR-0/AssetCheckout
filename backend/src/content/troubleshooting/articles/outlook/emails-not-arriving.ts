  ...
  steps: [
    {
      ...
      body: "Go to outlook.office.com/mail/ in a browser and sign in with your @ksb.com address. This is your mailbox as the server sees it. If the missing message is there; it arrived fine and the problem is the Outlook on this machine. If it isn't there; it never reached you and nothing on your laptop can change that.",
    ...
    {
      title: "Check your quarantined mail",
      body: "Go to https://mail-quarantine.ksb.com/ and sign in with your @ksb.com address, then look for the subject of the message you are waiting on. If it is there and labelled anything other than “clean”, “info mail” or “spam”, you cannot release it yourself; contact IT and they will work out how to get it to you.",
      note: "Mail is usually held because of what came with it rather than who sent it: macros, executable files, very old file formats, or unusual headers.",
    },
    {
      ...
      figure: {
        images: [
          {
            src: "outlook/emails-not-arriving/Outlook-rules-light.png",
            srcDark: "outlook/emails-not-arriving/Outlook-rules-dark.png",
          },
        ],
        size: "window",
    ...
    },
    {
      ...
      figure: {
        images: [
          {
            src: "outlook/emails-not-arriving/Outlook-offline-light.png",
            srcDark: "outlook/emails-not-arriving/Outlook-offline-dark.png",
          },
        ],
        size: "full",
